...
IMAGE := emgag/php
IMAGE_70_VERSION := 7.0.33-2
IMAGE_70_UPSTREAM := 7.0.33
IMAGE_71_VERSION := 7.1.28-1
IMAGE_71_UPSTREAM := 7.1.28
IMAGE_72_VERSION := 7.2.17-1
IMAGE_72_UPSTREAM := 7.2.17
IMAGE_73_VERSION := 7.3.4-1
IMAGE_73_UPSTREAM := 7.3.4
