...
IMAGE := emgag/php
IMAGE_71_VERSION := 7.1.32-3
IMAGE_71_UPSTREAM := 7.1.32
IMAGE_72_VERSION := 7.2.23-2
IMAGE_72_UPSTREAM := 7.2.23
IMAGE_73_VERSION := 7.3.10-2
IMAGE_73_UPSTREAM := 7.3.10
IMAGE_74_VERSION := 7.4.0RC3-1
IMAGE_74_UPSTREAM := 7.4.0RC3
