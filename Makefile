...
IMAGE := emgag/php
IMAGE_70_VERSION := 7.0.33
IMAGE_70_UPSTREAM := 7.0.33
IMAGE_71_VERSION := 7.1.27
IMAGE_71_UPSTREAM := 7.1.27
IMAGE_72_VERSION := 7.2.16
IMAGE_72_UPSTREAM := 7.2.16
IMAGE_73_VERSION := 7.3.3
IMAGE_73_UPSTREAM := 7.3.3
